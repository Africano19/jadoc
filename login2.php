                                    ...
                                    <div class="tab-content">
                                        <div class="tab-pane active" id="tab5">
                                            ...
                                            <div class="container-login100-form-btn">
                                                <input type=button class="login100-form-btn btn-primary" value="Entrar" name="but_submit" id="but_submit" style="width: 100%;" onclick="login()"/>
                                            </div>
                                        </div>
