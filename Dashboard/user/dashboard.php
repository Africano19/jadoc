                ...
                <div class="side-app">
                    ...
                    <div class="main-container container-fluid">
                        ...
                        <div class="row" id="Services_Dash">
                          <h2 class="page-title" style="color:#d17878;">Serviços:</h2>
                        ...
                        <div class="row" id="contab_dash">
                          <h2 class="page-title" style="color:#d17878;">Contabilidade:</h2>
                           <div class="col-lg-6 col-md-12">
                              <div class="card">
                                 <div class="card-header">
                                    <h3 class="card-title">Contabilidade Organizada</h3>
                                  </div>
                                    <div class="card-body">
                            ...
                            <div class="col-lg-6 col-md-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="card-title">Contabilidade Não Organizada</h3>
                                    </div>
                                    <div class="card-body">
